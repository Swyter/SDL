/*
  ...
  Copyright (C) 2024 Ismael Ferreras Morezuelas <swyterzone+sdl@gmail.com>
...
static void HIDAPI_DriverPS5_VR2Sense_HandleStatePacketCommon(SDL_Joystick *joystick, SDL_hid_device *dev, SDL_DriverPS5_Context *ctx, PS5StatePacketCommon_t *packet)
{
    ...
    /*
      ...
      data[8] 0x02 cross button
      data[8] 0x04 circle button
      ...
      data[1] 0xff - x axis, 0xff is right (analog)
      data[2] 0xff - y axis, 0xff is down  (analog)
